...
extension LoginViewController {
    ...
    private func login() {
            ...
            if username == "Teacher" && password == "Welcome" {
    ...
    //  Named parameters and argument labels - extra parameters(withMessage) infront of the main parameter (message) ---> look up in documentation
